...
<form class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-5">
                <input id="straat" name="straat" type="text" placeholder="" class="form-control input-md" required="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-5">
                <input id="huisnummer" name="huisnummer" type="text" placeholder="" class="form-control input-md">
